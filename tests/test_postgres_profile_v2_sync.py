...
def test_sync_upvote_projects_v2_in_the_direct_database_transaction(
    ...
    monkeypatch.setattr(postgres, "load_news_topic_ids", lambda *args, **kwargs: [10, 20])
...
def test_sync_pre_reset_upvote_records_fact_without_mutating_v1_or_v2(
    ...
    monkeypatch.setattr(postgres, "fetch_profile_row", lambda *args, **kwargs: {})
    monkeypatch.setattr(postgres, "load_news_topic_ids", lambda *args, **kwargs: [10])
    monkeypatch.setattr(postgres, "record_click_event", lambda *args, **kwargs: None)
    monkeypatch.setattr(postgres, "record_sponsored_click", lambda *args, **kwargs: None)
    monkeypatch.setattr(
        postgres,
...
def test_sync_pre_reset_search_records_fact_without_restoring_v1_profile(
    ...
    monkeypatch.setattr(
        ...
        lambda *args, **kwargs: ("catalog-fingerprint", 0),
    )
    monkeypatch.setattr(
        postgres,
    ...
    monkeypatch.setattr(postgres, "load_news_rows", lambda *args: {})
    monkeypatch.setattr(postgres, "load_topics_by_news", lambda *args: {})
